#!/bin/bash
# entrypoint-client.sh - Wrapper script for imquic-moq-interop-test
# Translates standard MoQT interop environment variables to imquic-moq-interop-test CLI
#
...
exec /app/imquic-moq-interop-test ${ARGS[@]+"${ARGS[@]}"}
